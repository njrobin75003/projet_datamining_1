---
title: "MBA-ESG-MBDCDO-Data-Mining-R-Markdown-Cours-02-et-03-2018-11-12"
...
* **Étape 1 : le calcul des statistiques descriptives.**

* **Étape 2 : le groupement des modalités intéressantes.**

* **Étape 3 : la régression logistique.**
...
\
La courbe de ROC avait été traitée lors du premier envoi. C'est pourquoi nous l'avons laissée dans le présent document. Nous expliquerons cette courbe dans le prochain livrable de ce R-Markdown, livrable qui devra aussi inclure la courbe de gain. Si vous êtes d'accord, pouvez-vous nous faire déjà un retour sur cette courbe de manière à pouvoir y apporter des informations qui vous apparaissent comme étant manquantes ?
