...
\
La courbe de ROC avait été traitée lors du premier envoi. C'est pourquoi nous l'avons laissée dans le document.Nous expliquerons cette courbe dans le prochain livrable de ce R-Markdown qui inclura la courbe de gain.
